<template>
    <v-container fluid class="white rounded shadow1 py-2 mb-3">
        ...
        <v-row v-if="show">
            <v-col cols="12">
                <v-btn v-on:click.prevent="print">Print</v-btn>
            </v-col>
            <v-col cols="12" id="invoiceContent">
                ...
                >
                    ...
                    <template slot="body.append">
                        <tr class="pink--text">
                            <th class="title" colspan="4" style="text-align: right;">
                                Total of all ({{ lodash.size($store.getters['purchase/purchases']) }}) record
                            </th>
                            <th class="title">
                                {{ lodash.sumBy($store.getters['purchase/purchases'], item => +item.sub_total) }}
                            </th>
                            <th class="title">
                                {{ lodash.sumBy($store.getters['purchase/purchases'], item => +item.total) }}
                            </th>
                            <th class="title">
                                {{ lodash.sumBy($store.getters['purchase/purchases'], item => +item.paid) }}
                            </th>
                            <th class="title">
                                {{ lodash.sumBy($store.getters['purchase/purchases'], item => +item.due) }}
                            </th>
                            <th class="title"></th>
                            <th class="title"></th>
                        </tr>
        ...
        <div id="printTable" style="display: none;">
            <table class="bordered-table">
                ...
                <tr v-for="(item, index) in $store.getters['purchase/purchases']" :key="index">
                                        ...
                                        <td>
                                            <div class="custom-row">
                                                <div class="invoice-title">
                                                    Purchase Record from <span style="color:red;">${this.purchase.dateFrom}</span> To <span style="color:red;">${this.purchase.dateTo}</span>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
