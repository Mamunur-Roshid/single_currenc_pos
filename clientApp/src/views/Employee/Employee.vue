                        ...
                        <v-card-text class="py-0">
                            <v-row>
                                <v-col cols="12" md="6">
                                    ...
                                    <v-row>
                                        <v-col cols="4" class="py-1 pr-1 caption">Area <span style="color:red;">*</span></v-col>
                                        <v-col cols="8" class="py-0">
                                            <v-combobox
                                                dense
                                                outlined
                                    ...
                                    <v-row>
                                        <v-col cols="4" class="py-1 pr-1 caption">Country <span style="color:red;">*</span></v-col>
                                        <v-col cols="8" class="py-0">
                                            <v-combobox
                                                dense
                                                outlined
                                    ...
                                    <v-row>
                                        <v-col cols="4" class="py-1 pr-1 caption">Contact Number</v-col>
                                        <v-col cols="8" class="py-0">
                                            <v-text-field
                                                dense
                                                outlined
