                        ...
                        <v-col cols="12" md="9">
                            <v-row dense>
                                    ...
                                    >
                                        ...
                                        <v-card-text class="py-1 pa-0 pl-2 pr-2">
                                            <v-form ref="productForm" class="custom-form" @submit.prevent="addToCart">
                                                ...
                                                <v-row class="py-2">
                                                    <v-col cols="2" class="py-1 caption">Sale Rate</v-col>
                                                    ...
                                                    <v-col cols="4" class="py-0 pa-0 pr-3">
                                                        <v-text-field
                                                            dense
                                                            outlined
                                                            hide-details
                                ...
                                <v-col cols="2">
                                    ...
                                    >
                                        <v-toolbar color="white lighten-4" :elevation="1" height="40px">
                                            <v-toolbar-title class="subtitle-2">Credit Limit</v-toolbar-title>
                                        </v-toolbar>
                                        <v-card-text class="py-1">
                                            <div class="stock" style="font-size: 16px;" v-if="lodash.get(customer, 'credit_limit') > 0">
                                                {{ lodash.get(customer, 'credit_limit')}}
                                            </div>
                                            <div class="stock" style="font-size: 16px;" v-else>
                                                Not Applicable
                                            </div>
                                        </v-card-text>
                                    </v-card>
                                                ...
                                                <template v-slot:default>
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(cart, ind) in cart" :key="ind">
                                                            ...
                                                            <td>{{cart.name}}</td>
                                                            <td class="text-right" style="width:12%">{{cart.sale_rate}}</td>
                            ...
                            <v-row style="padding: 10px;">
                                <div style="background: white;width: 100%;padding: 10px 20px;">
                                    <p>Note:</p>
                                    <v-textarea
                                    style="width: 100%;"
                                        dense
                                ...
                                <v-col cols="12">
                                    ...
                                    >
                                        ...
                                        <v-card-text class="py-1 pa-0 pl-2 pr-2">
                                            ...
                                            <v-row no-gutters>
                                                <v-col cols="4" class="py-1 caption">Old Due</v-col>
                                                <v-col cols="8" class="py-0">
                                                    <v-text-field
                                                        dense
                                                        outlined
                                                        ...
                                                        v-model.number="sale.previous_due"
                                                        @input="calculateTotal"
                                                        readonly
                                                    ></v-text-field>
                                                </v-col>
                                            ...
                                            <v-row no-gutters>
                                                ...
                                                <v-col cols="8" class="py-0">
                                                    <v-text-field
                                                        ...
                                                        hide-details
                                                        readonly
                                                        :value="Number(sale.previous_due || 0) + Number(sale.due || 0)"
                                                        ></v-text-field>
                                                        <!-- @input="calculateTotal" -->
                                                </v-col>
...
export default {
    ...
    methods: {
        ...
        validateSale() {
            ...
            // console.log(+this.sale.due + +this.sale.previous_due > +this.customer.credit_limit);
            // console.log(+this.sale.due + +this.sale.previous_due, +this.customer.credit_limit);
            if(+this.customer.credit_limit > 0) {
                if (+this.sale.due + +this.sale.previous_due > +this.customer.credit_limit) {
                    this.$store.dispatch('snackbar/error', 'Credit Limit Over');
                    isValid = false; 
                    return isValid;
                }
            }
            ...
            if(res) {
                ...
                if(res.isSuccess) {
                    ...
                    swal({
                        ...
                        if (response){
                            this.$router.push(`/sale-invoice/${res.id}`)
                        } else {
                            location.reload();
                        }
                    })
