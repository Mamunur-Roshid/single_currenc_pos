        ...
        <div v-if="show" style="display: none;">
            <div cols="12" id="printContent">
                <table class="bordered-table">
                    ...
                    <tbody>
                        <tr v-for="(payment, ind) in $store.getters['customer/payments']" :key="ind">
                            <td style="text-align: center;" class="text-center">{{ payment.sl }}</td>
                            <td style="text-align: center;" class="text-center">{{ payment.invoice }}</td>
                            ...
                            <td style="text-align: right;" class="text-right">{{ payment.amount }}</td>
                        </tr>
                        <tr>
                            <td colspan="5" class="text-right"><strong>Total</strong></td>
                            <td class="text-right"><strong>{{ total }}</strong></td>
                            ...
                            <div class="custom-row">
                                <div class="col-xs-12">
                                    ...
                                    <div style="text-align:left;">
                                        Customer Name: ${_.get(this.customer, 'name')} </br>
                                        Customer Id: ${_.get(this.customer, 'code')}
                                    </div>
                                    <div style="text-align:center;font-weight:bold;padding-bottom:10px;">
                                        Customer Payments </br> From ${this.filter.dateFrom} to ${this.filter.dateTo}
                                    </div>
                                </div>
                            </div>
