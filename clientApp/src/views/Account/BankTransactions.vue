                    ...
                    <template v-slot:default>
                        ...
                        <tbody>
                            <tr v-for="(transaction , sl) in $store.getters['bankTransaction/transactions']" :key="sl">
                                ...
                                <td class="text-center">{{ lodash.get(transaction, 'bank.account_name') }}</td>
                                <td class="text-center">{{ lodash.get(transaction, 'bank.account_number') }}</td>
                                <td class="text-center">{{ lodash.get(transaction, 'bank.bank_name') }}</td>
...
export default {
    ...
    methods: {
        ...
        async print(){
            ...
            let byTxt = ''
            if (this.searchType == 'By Account') {
                byTxt += 'By Account '
                if (this.account) {
                    byTxt += ` <span style="color:red;">${this.account.display_text}</span>`
                }
            }
