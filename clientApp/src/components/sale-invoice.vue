            ...
            <div class="custom-row">
                <div class="col-xs-7">
                    <div class="paid-text" style="margin-top: 20px;">
                        ...
                        <p style="margin-top: 20px"><strong>Note : </strong> {{ sale.note }}</p>
                    </div>
                </div>
                <div class="col-xs-5">
                    <table width="100%">
                        ...
                        <tr>
                            <td width="45%" class="b-text">Previous due:</td>
                            <td class="text-right">{{ sale.previous_due }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-right">{{ Number(Number(sale.due || 0) + Number(sale.previous_due || 0)).toFixed(2) }}</td>
                        </tr>
                    </table> 
                </div>
            </div>
...
import { invoiceHeader, invoiceFooter } from '../composable/usePrint';
export default {
    props: ['saleId'],
