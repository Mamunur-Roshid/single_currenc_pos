                    ...
                    <tr>
                        <th>
                            <div class="relative mb-5 flex items-center justify-center gap-5">
                                <div>
                                    <img style="width: 60px" :src="info.ImagePath" alt="SK" />
                                </div>
                                <div class="text-center">
                                    <h2 class="font-serif font-bold uppercase black-heading-color" style="font-size: 27px;">S.K MACHINERIES</h2>
                                    <h2 class="font-serif font-bold uppercase red-heading-color" style="font-size: 27px;">S.K Auto house</h2>
                                </div>
                            </div>
                        ...
                        <td>
                            <table class="mt-2 w-full bordered-table">
                                <tbody>
                                    <tr>
                                        <th colspan="6">
                                            <div style="display:grid;grid-template-columns: repeat(2, 1fr);font-weight: normal;">
                                    ...
                                    <!-- <template v-for="indx in 10">
                                        <tr v-for="(detail, ind) in sale.sale_details" :key="ind">
                                            <td class="text-center">
                                                {{ (sale.sale_details.length * (indx - 1)) + (ind + 1) }}
                                            </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right p3" style="text-align: right;">
                                            {{ sale.total }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="5" class="text-right p3" style="text-align: right;">Previous due</td>
                                        <td class="text-right p3" style="text-align: right;">
                                            {{ sale.previous_due }}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-right p3" style="text-align: right;">Paid Amount</td>
                                        <td class="text-right p3" style="text-align: right;">
                                            {{ sale.paid }}
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="text-right p3">
                                            {{ Number(sale.due || 0) + Number(sale.previous_due || 0) }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <tfoot>
                    <tr>
                        <th>
                            ...
                            <div style="font-size: 13px;" v-if="sale.note">
                                <strong class="b-text" style="font-weight:bold;"> note: </strong>
                                <span class="normal-text">
                                    {{ sale.note }}
                                </span>
                            </div>
                            <div class="flex items-center justify-between" style="margin-top:20px;display: flex;align-items: center;justify-content:space-between;">
                                ...
                                <img :src="`${$store.state.hostName}/images/bootom-logos-lt.png`" style="max-width:50%;" alt="Some" />
                                <span class="font-bold text-[#24298d]" style="font-weight: bold;color: #24298d;">
                                    <div>______________________</div>
        ...
        async print() {
            ...
            printWindow.document.write(`
                ...
                <head>
                    ...
                    <title>Sale invoice - ${this.sale.invoice}</title>
                    <style>
                    ${invoiceStyle}
                    </style>
                </head>
