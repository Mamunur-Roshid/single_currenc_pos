...
class CustomerController extends Controller
{
    ...
    public function AddCustomer(Request $req)
    {
        ...
        $customerKeys = ['code', 'name', 'phone', 'email', 'area_id', 'opening_balance', 'address', 'org_name', 'org_phone', 'credit_limit', 'type'];
    ...
    {
        $customer_due[0]['due'] = 0;
        $customers = $req->customerId == NULL ? $customer_due : $this->customerRepo->GetCustomerDue($req->all());
        return response()->json(['customers' => $customers], 200);
    }
